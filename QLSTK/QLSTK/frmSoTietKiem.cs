...
namespace QLSTK
{
    public partial class frmSoTietKiem : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void BtnThem_Click(object sender, EventArgs e)
        {
            ...
            stk.StrNgayMoSo = txtNgayMoSo.Value.ToString();
            stk.DSoDu = double.Parse(txtSoTienGui.Text);
            stk.StrNgayChinhSua = (DateTime.Now).ToString();
            //----------------------------------------
        ...
        private void txtMaKH_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                txtDiaChi.Text = khachHang.StrDiaChi;
        ...
        private void txtMaSoSTK_TextChanged(object sender, EventArgs e)
        {
            try
            {
                SoTietKiemDTO soTietKiemDTO = stkBUS.getSoTietKiem(txtMaSoSTK.Text);
                txtMaKH.Text = soTietKiemDTO.StrMaKH;
                txtSoTienGui.Text = soTietKiemDTO.DSoDu.ToString();
                cmbLoaiTietKiem.SelectedValue = soTietKiemDTO.StrMaLTK;
                txtNgayMoSo.Value = DateTime.Parse(soTietKiemDTO.StrNgayMoSo);
            }
            catch
            {
                return;
